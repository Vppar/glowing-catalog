...
describe('Service: OrderKeeperUpdateItemQtySpec', function() {
    ...
    it('should update an order', function() {
        ...
        var receiveCall = function() {
            OrderKeeper.updateItemQty(addEv.uuid, items);
        };
    ...
    it('shouldn\'t update an order', function() {
        ...
        // when
        var receiveCall = function() {
            OrderKeeper.updateItemQty('cc02b600-5d0b-11e3-96c3-010001000002', null);
        };
