describe('Service: PurchaseOrderServiceCreateSpec\n', function() {
    ...
    describe('Given a valid purchase order\n', function() {
        ...
        describe('and the keeper returning a resolved promise\n', function() {
            beforeEach(function() {
                PurchaseOrderKeeper.add = jasmine.createSpy('PurchaseOrderKeeper.add').andCallFake(PromiseHelper.resolved(uuid));
            });

            describe('When create is called\n Then', function() {
                beforeEach(function() {
                    runs(function() {
                        PurchaseOrderService.create(purchaseOrder).then(function(uuid) {
                            promiseResult = uuid;
                        });
                    });
                    waitsFor(function() {
                ...
                it('should call PurchaseOrderKeeper.add', function() {
                    expect(PurchaseOrderKeeper.add).toHaveBeenCalledWith(new PurchaseOrder(purchaseOrder));
                });
        ...
        describe('and the keeper returning a rejected promise\n', function() {
            beforeEach(function() {
                PurchaseOrderKeeper.add = jasmine.createSpy('PurchaseOrderKeeper.add').andCallFake(PromiseHelper.rejected('rejected'));
            });
            
            describe('When create is called\n Then', function() {
                beforeEach(function() {
                    runs(function() {
                        PurchaseOrderService.create(purchaseOrder).then(null, function(err) {
                            promiseResult = err;
                        });
                    });
                    waitsFor(function() {
                ...
                it('shouldn\'t call PurchaseOrderKeeper.add', function() {
                    expect(PurchaseOrderKeeper.add).not.toHaveBeenCalledWith();
                });
    ...
    describe('Given a invalid purchase order\n', function() {
        beforeEach(function() {
            ...
            PurchaseOrderKeeper.add = jasmine.createSpy('PurchaseOrderKeeper.add');
        });
        describe('When create is called\n Then', function() {
