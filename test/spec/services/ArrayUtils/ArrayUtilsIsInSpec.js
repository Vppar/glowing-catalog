...
describe('Service: ArrayUtils', function() {
    ...
    //FIXME
    xit('should find with objects', function() {
        // given
        var array = [ {
            property : {a:'a'},
            property1 : {b:'b'},
    ...
    xit('should not find', function() {
        ...
        var response = ArrayUtils.isIn(array, property, ids);
        expect(response.lenght).toBe(0);
    });
    
    //FIXME - return undefined
    xit('should not find, invalid properties', function() {
        // given
        var array = [ {
            property : 1,
            property1 : 2,
        ...
        var property = 'property89';
        var ids = [ 1, 9 ];

        var response = ArrayUtils.isIn(array, property, ids);
        expect(response.lenght).toEqual(0);
    });
    
    //FIXME - should return a empty array
    xit('should not find', function() {
        // given
        var array = [ {
            property : 'yolo',
