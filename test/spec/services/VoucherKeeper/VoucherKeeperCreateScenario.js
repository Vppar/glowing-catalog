...
describe('Service: VoucherKeeper.create', function() {
     ...
     * <pre>
     * @spec VoucherKeeper.create#1
     * Given a invalid voucher
     * when create is triggered
     * then a voucher must throw a exception
     * </pre>
     */
    it('throw a exception', function() {
        var ev = {
                id:1
        };
        
        var createCall = function(){VoucherKeeper.create(ev);};
        
        expect(createCall).toThrow('Wrong instance to VoucherKeeper');
    });
});
