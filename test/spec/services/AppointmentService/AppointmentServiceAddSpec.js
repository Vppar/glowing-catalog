describe('Service: AppointmentServiceAddSpec', function() {
	...
	it('should create a appointment instance', function() {
		// given
		AppointmentKeeper.create = jasmine
				.createSpy('AppointmentKeeper.create');
		...
		// then
		expect(AppointmentKeeper.create).toHaveBeenCalledWith(
	...
	it('shouldn\'t create a appointment instance', function() {
		...
		AppointmentService.isValid = jasmine.createSpy(
				'AppointmentService.isValid').andReturn([]);
		AppointmentKeeper.create = jasmine
				.createSpy('AppointmentKeeper.create').andCallFake(function() {
					throw 'my exception';
				});
		var appointment = {
			uuid : 1,
