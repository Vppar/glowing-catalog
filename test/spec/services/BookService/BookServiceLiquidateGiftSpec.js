...
describe('Service: BookServiceLiquidateGiftSpec', function() {
    ...
    it('should create a receive check BookEntry', function() {
        ...
        // When
        var result = BookService.liquidateGift(document.uuid, entityUUID, giftAmount);
    ...
    it('shouldn\'t create a receive check BookEntry', function() {
        ...
        // When
        var result = BookService.liquidateGift(document.uuid, entityUUID, 0);
