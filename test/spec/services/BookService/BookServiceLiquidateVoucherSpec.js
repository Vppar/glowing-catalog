...
describe('Service: BookServiceLiquidateVoucherSpec', function() {
    ...
    it('should create a receive check BookEntry', function() {
        ...
        // When
        var result = BookService.liquidateVoucher(document.uuid, entityUUID, voucherAmount);
    ...
    it('shouldn\'t create a receive check BookEntry', function() {
        ...
        // When
        var result = BookService.liquidateVoucher(document.uuid, entityUUID, 0);
