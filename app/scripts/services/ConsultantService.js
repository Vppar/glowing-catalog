    ...
    angular
        ...
        .service(
            ...
            [
                ...
                'ConsultantKeeper',
                'Consultant',
                function ConsultantService (logger, $q, ConsultantKeeper, Consultant) {
                    ...
                    this.list =
                        function () {
                            ...
                            try {
                                ...
                                log
                                    .debug('ConsultantService.list: Unable to recover the list of Consultant. Err=' +
                                        err);
                            }
                            return result;
                        };
                    ...
                    this.read =
                        function (uuid) {
                            ...
                            try {
                                ...
                                log
                                    .debug('ConsultantService.read: Unable to find a consultant with id=\'' +
                                        uuid + '. Err=' + err);
                            }
                            return result;
                        };
                        ...
                        function (consultant) {
                            ...
                            if (result.length === 0) {
                                    ...
                                    return promise.then(function(resp){
                                        ...
                                        return $q.reject(log.error('ConsultantService.update: Unable to update a consultant=' +
                                                 + '. Err=' + error));
                                    });
                                }else{
