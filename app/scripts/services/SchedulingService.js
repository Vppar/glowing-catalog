(function (angular) {
    ...
    angular.module('tnt.catalog.scheduling.service', [
                ...
                var read =
                    function read (id) {
                        ...
                        try {
                            ...
                            log.debug('OrderService.read: Unable to find an order with the id=' +
                                id + '. ' + 'Err=' + err);
                        }
                        return result;
                    };
                ...
                var update =
                    function update (id, date, items, status) {
                        ...
                        try {
                            ...
                            log.debug('OrderService.update: Unable to update the order with id=' +
                                id + '. ' + 'Err=' + err);
                            result = $q.reject(err);
                        }
                        return result;
