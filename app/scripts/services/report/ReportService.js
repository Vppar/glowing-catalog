(function(angular) {
    ...
    angular.module('tnt.catalog.report.service', [
        ...
        function ReportService(FinancialMathService) {
            ...
            this.augmentReserveAndQty = function augmentReserveAndQty(type, reportItem) {
            ...
            /**
             * Builds a session in a report object. If the session already exist
             * in report summarizes amount, qty and average cost.
             * 
             * @param {object} report - Report object.
             * @param {object} reportItem - Item object.
             * @return {object} session - Report session object.
             */
            this.buildSession = function buildSession(report, reportItem) {
                ...
                session.total.amount += FinancialMathService.currencyMultiply(reportItem.cost, reportItem.qty);
                session.total.avgCost = FinancialMathService.currencyDivide(session.total.amount, session.total.qty);

                return session;
            };

            /**
             * Builds a line in a report object. If the session already exist in
             * report summarizes amount, qty and average cost.
             * 
             * @param {object} report - Report object.
             * @param {object} reportItem - Item object.
             */
            this.buildLine = function buildLine(session, reportItem) {
                ...
                line.total.amount += FinancialMathService.currencyMultiply(reportItem.cost, reportItem.qty);
                line.total.avgCost = FinancialMathService.currencyDivide(line.total.amount, line.total.qty);
