(function(angular) {
    ...
    angular.module('tnt.catalog.order.service', []).service('OrderService', function OrderService($rootScope, $log, Order, OrderKeeper, DataProvider) {
        ...
        var isValid = function isValid(order) {
          ...
          invalidProperty = {
            // FIXME: implement order code validation once the generator
            // is implemented.
         ...
         */
        // FIXME: OrderKeeper.cancel() does not returns anything. Confirm if
        // this is the expected behavior and update this method if needed.
