    ...
    angular.module('tnt.catalog.stock.service', [
        'tnt.catalog.inventory', 'tnt.catalog.stock', 'tnt.catalog.financial.math.service', 'tnt.catalog.report.service'
            ...
            [
                ...
                'ReportService',
                function StockService($q, logger, InventoryKeeper, Stock, StockKeeper, ArrayUtils, FinancialMathService, ReportService) {
                    ...
                    this.add = function add(item) {
                        ...
                        if (hasErrors.length === 0) {
                            ...
                            log.error('StockService.add: -Invalid item. ', hasErrors);
