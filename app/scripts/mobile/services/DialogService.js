(function(angular) {
    ...
    angular.module('tnt.catalog.service.dialog',['ui.bootstrap']).service('DialogService', ['$q','$dialog', function($q, $dialog) {
        ...
        this.openDialogAddToBasket = function(data) {
            return openDialog('views/mobile/parts/catalog/add-to-basket-dialog.html', 'AddToBasketDialogCtrl', data, 'modal-add-basket-dialog');
        };

        this.openDialogAddToBasketSku = function(data) {
            return openDialog('views/mobile/parts/catalog/add-to-basket-dialog-sku.html', 'AddToBasketDialogCtrl', data, 'modal-add-basket-payment-dialog modal-add-basket-dialog');
         };
...
//            return openDialog('views/parts/catalog/add-to-basket-dialog-details.html', 'AddToBasketDialogCtrl', data, 'modal-add-basket-details-dialog');
        ...
        this.openDialogLoading = function (data) {
            ...
            dialog.open('views/mobile/parts/global/loading-dialog.html', 'LoadingDialogCtrl');
