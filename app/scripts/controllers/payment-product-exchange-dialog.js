(function(angular) {
    ...
    angular.module('glowingCatalogApp').controller(
            'PaymentProductExchangeDialogCtrl', function($scope, $filter, dialog, DataProvider) {

                /**
                 * @var dataProvider - receives data from DataProvider
                 *      (DataProvider.js)
                 */
                 ...
                 */
                $scope.addExchangeProduct = function(product, productList) {
