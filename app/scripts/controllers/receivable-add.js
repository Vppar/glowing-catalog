    ...
    angular.module(
        ...
        [
            ...
            [
                ...
                'EntityService',
                'TypeKeeper',
                function ($scope, $q, ReceivableService, Receivable, Misplacedservice,
                    EntityService, TypeKeeper) {
                    ...
                    $scope.createInstallments =
                        function createInstallments () {
                            ...
                            Misplacedservice.recalc(
                                $scope.receivable.amount,
                                -1,
                                installments,
                                'amount');
                            ...
                            for ( var idx in installments) {
                                ...
                                mReceivable =
                                    new Receivable(
                                        null,
                                        new Date(),
                                        $scope.receivable.customerId,
                                        installments[idx].amount,
                                        properDate(copyDate, idx));
                    ...
                    function properDate (baseDate, increase) {
                        var date =
                            new Date(baseDate.getYear(), baseDate.getMonth() + 1 + increase, 0);
                        if (baseDate.getDate() > date.getDate()) {
                            return date;
                        } else {
                            return baseDate.setMonth((parseInt(baseDate.getMonth(), 10) + parseInt(
                                increase,
                                10)));
                        }
                    }
