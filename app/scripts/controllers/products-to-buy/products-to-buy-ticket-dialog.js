(function (angular) {
    ...
    angular.module('tnt.catalog.productsToBuy.ticket.dialog.ctrl', []).controller(
        'ProductsToBuyTicketDialogCtrl',
        [
            '$scope', '$q', '$filter', 'dialog', function ($scope, $q, $filter, dialog) {
